...
<head>
    ...
    <meta charset="utf-8" />
    <title>流程管理控制平台</title>
    <meta name="description" content="" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
    <%@ include file="../common/index-static.jsp"%>
</head>
<body class="no-skin" >
                    ...
                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${ctx }/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${ctx }/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
...
<script src="${ctx }/workflow/js/index.js"></script>
